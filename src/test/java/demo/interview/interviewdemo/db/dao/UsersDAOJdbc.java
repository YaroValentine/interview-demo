...
import demo.interview.interviewdemo.db.DataSourceProvider;
...
public class UsersDAOJdbc implements UsersDAO {
    private static final DataSource dataSource = DataSourceProvider.INSTANCE.getDataSource(ServiceDB.DB_AUTH);
